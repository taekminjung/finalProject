	...
	<div class="box box-info">
	  ...
	  <div class="box-body">
	      ...
	      <div class="btn-group" style="display: flex; justify-content: center;">
          	...
          	<a href="${pageContext.request.contextPath}/sportsEquipmentOrderState?currentPage=${currentPage-1}&branchNo=${loginEmployee.branchNo}" class="btn btn-info">이전</a>
            </c:if>
            <a class="btn btn-info active">${currentPage}</a>
            <c:if test="${currentPage < lastPage}">
            <a href="${pageContext.request.contextPath}/sportsEquipmentOrderState?currentPage=${currentPage+1}&branchNo=${loginEmployee.branchNo}" class="btn btn-info">다음</a>
          	</c:if>
          </div>
	    </div>
	  <!-- /.box-body -->
