					...
					<div class="navigation-area">
						<div class="row">
							<div class="col-lg-6 col-md-6 col-12 nav-left flex-row d-flex justify-content-start align-items-center">
								<div class="thumb">
									<a href="#"><img class="customer/img-fluid" src="customer/img/blog/prev.jpg" alt=""></a>
								</div>
								<div class="arrow">
							...
							<div class="col-lg-6 col-md-6 col-12 nav-right flex-row d-flex justify-content-end align-items-center">
								...
								<div class="thumb">
									<a href="#"><img class="customer/img-fluid" src="customer/img/blog/next.jpg" alt=""></a>
								</div>
							</div>
						</div>
					</div>
					<div class="comments-area">
						...
						<div class="comment-list">
							<div class="single-comment justify-content-between d-flex">
								<div class="user justify-content-between d-flex">
									<div class="thumb">
										<img src="customer/img/blog/c1.jpg" alt="">
									</div>
									<div class="desc">
						...
						<div class="comment-list left-padding">
							<div class="single-comment justify-content-between d-flex">
								<div class="user justify-content-between d-flex">
									<div class="thumb">
										<img src="customer/img/blog/c2.jpg" alt="">
									</div>
									<div class="desc">
						...
						<div class="comment-list left-padding">
							<div class="single-comment justify-content-between d-flex">
								<div class="user justify-content-between d-flex">
									<div class="thumb">
										<img src="customer/img/blog/c3.jpg" alt="">
									</div>
									<div class="desc">
						...
						<div class="comment-list">
							<div class="single-comment justify-content-between d-flex">
								<div class="user justify-content-between d-flex">
									<div class="thumb">
										<img src="customer/img/blog/c4.jpg" alt="">
									</div>
									<div class="desc">
						...
						<div class="comment-list">
							<div class="single-comment justify-content-between d-flex">
								<div class="user justify-content-between d-flex">
									<div class="thumb">
										<img src="customer/img/blog/c5.jpg" alt="">
									</div>
									<div class="desc">
				...
				<div class="col-lg-4 sidebar-widgets">
					<div class="widget-wrap">
						...
						<div class="single-sidebar-widget popular-post-widget">
							...
							<div class="popular-post-list">
								<div class="single-post-list d-flex flex-row align-items-center">
									<div class="thumb">
										<img class="customer/img-fluid" src="customer/img/blog/pp1.jpg" alt="">
									</div>
									<div class="details">
								...
								<div class="single-post-list d-flex flex-row align-items-center">
									<div class="thumb">
										<img class="customer/img-fluid" src="customer/img/blog/pp2.jpg" alt="">
									</div>
									<div class="details">
								...
								<div class="single-post-list d-flex flex-row align-items-center">
									<div class="thumb">
										<img class="customer/img-fluid" src="customer/img/blog/pp3.jpg" alt="">
									</div>
									<div class="details">
								...
								<div class="single-post-list d-flex flex-row align-items-center">
									<div class="thumb">
										<img class="customer/img-fluid" src="customer/img/blog/pp4.jpg" alt="">
									</div>
									<div class="details">
						...
						<div class="single-sidebar-widget ads-widget">
							<a href="#"><img class="customer/img-fluid" src="customer/img/blog/ads-banner.jpg" alt=""></a>
						</div>
