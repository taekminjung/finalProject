...
<body>
			...
			<div class="row d-flex align-items-center justify-content-center">
				<div class="about-content col-lg-12">
					...
					<p class="link-nav">
						...
						<span class="lnr lnr-arrow-right"></span>
						<a href="${pageContext.request.contextPath }/updateCustomerPw?customerNo=${loginCustomer.customerNo}">
							Change PW
						</a>
					</p>
				</div>
	...
	<div class="container">
		<div class="row">
			...
			<h3>비밀번호 변경</h3><br><br>
				<form name="form" id="form" method="post" action="${pageContext.request.contextPath }/updateCustomerPw">
					<div class="col-lg-8">
						<div class="row">
							<p>현재 비밀번호</p>
						...
						<div class="row">
							<p>새로운 비밀번호</p>
							<input id="newPw" type="password" name="newCustomerPw" class="single-input">
						</div><br><br>
						<div class="row">
							<p>새로운 비밀번호 확인</p>
							<input id="newPwCk" type="password" class="single-input">
						</div><br><br>
						<div>
							<input type="hidden" id="customerId" name="customerId" value="${loginCustomer.customerId }">
							<input type="hidden" id="customerNo" name="customerNo" value="${loginCustomer.customerNo }">
						</div>
					</div>
				</form>
				<div align="center">
					<p></p>
					<button id="formBtn" class="genric-btn primary-border circle e-large">변경</button>
				</div>
			</div>
		</div>
	</div><br><br>
		...
		$('#formBtn').click(function(){
			if($('#pw').val().length < 1){
				...
				$.ajax({
					...
					method:'post',
					data:{'customerPw':$('#pw').val(),'customerId':$('#customerId').val()},
